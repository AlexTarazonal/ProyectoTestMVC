...
namespace ProyectoTestMVC.Controllers
{
    public class StocksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,WarehouseId,Quantity,CreatedAt,UpdatedAt")] Stock stock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,WarehouseId,Quantity,CreatedAt,UpdatedAt")] Stock stock)
        {
